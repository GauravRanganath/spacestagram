...
var ReactTextCollapse = /*#__PURE__*/function (_Component) {
  _inherits(ReactTextCollapse, _Component);

  var _super = _createSuper(ReactTextCollapse);
  ...
  function ReactTextCollapse(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "toggleAction", function () {
  ...
  _createClass(ReactTextCollapse, [{
    ...
    value: function renderHelperText() {
      var _this$props$options = this.props.options,
          collapseText = _this$props$options.collapseText,
          expandText = _this$props$options.expandText,
          textStyle = _this$props$options.textStyle;
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          minHeight = _this$props$options2.minHeight,
          maxHeight = _this$props$options2.maxHeight,
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactMotion.Motion, {
        ...
        style: {
          h: (0, _reactMotion.spring)(collapse ? minHeight : maxHeight)
        }
      }, function (_ref) {
        var h = _ref.h;
...
_defineProperty(ReactTextCollapse, "propTypes", {
